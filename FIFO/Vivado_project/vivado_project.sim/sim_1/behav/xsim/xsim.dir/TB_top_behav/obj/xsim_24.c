...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPIRelocateDPIScopeIP(0, (char*)(0x616058)) ;
...
extern "C" {
	...
	extern void subprog_m_abdfe5f6_556ead11_2282(char*, char*, char*);
}
...
extern "C" {
...

	{
		...
		SP = DPIInitializeFunction(IP + 438936, 168, 1851048) ;
		char driver0[32] ;
		...
		DPIScheduleTransactionBlocking(IP +438432, driver0, (char*)(&copyArg_0_0), 0, 31) ;
		const char* copyArg_1_1[1] ;
		copyArg_1_1[0] = ( arg1) ;
		DPIScheduleTransactionBlocking(IP +438488, driver1, (char*)(&copyArg_1_1), 0, 31) ;
		const char* copyArg_2_2[1] ;
		copyArg_2_2[0] = ( arg2) ;
		DPIScheduleTransactionBlocking(IP +438544, driver2, (char*)(&copyArg_2_2), 0, 31) ;
		char copyArg_3_3[8];
		{
		...
		DPIScheduleTransactionBlocking(IP +438600, driver3, (char*)(&copyArg_3_3), 0, 31) ;
		const char* copyArg_4_4[1] ;
		copyArg_4_4[0] = ( arg4) ;
		DPIScheduleTransactionBlocking(IP +438656, driver4, (char*)(&copyArg_4_4), 0, 31) ;
		char copyArg_5_5[8];
		{
		...
		DPIScheduleTransactionBlocking(IP +438712, driver5, (char*)(&copyArg_5_5), 0, 31) ;
		char* oldSP = *((char**)(IP + callingProcessOffset + 80)) ; 
		DPIInvokeFunction(IP + callingProcessOffset, SP, (void*)(subprog_m_abdfe5f6_556ead11_2282), IP) ;
