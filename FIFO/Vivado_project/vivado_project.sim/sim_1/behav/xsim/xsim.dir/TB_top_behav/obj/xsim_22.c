...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPIRelocateDPIScopeIP(0, (char*)(0x4b2a60)) ;
...
extern "C" {
	...
	extern void subprog_m_1c8a86ae_556ead11_2282(char*, char*, char*);
}
...
extern "C" {
...

	{
		...
		SP = DPIInitializeFunction(IP + 438936, 168, 382848) ;
		char driver0[32] ;
		...
		DPIInvokeFunction(IP + callingProcessOffset, SP, (void*)(subprog_m_1c8a86ae_556ead11_2282), IP) ;
